...
import com.ust.selenium.common.utility.Constants;
import com.ust.selenium.common.utility.ThreadedItems;
	...
	public static WebDriver getDriver()
	{
		...
		if (threadDriver.get().getDriver() == null)
		{
			...
			if ("false".equals(local) && !"headless".equals(browser))
			{
				try
				{
					threadDriver.get().setDriver(new RemoteWebDriver(new URL("http://10.5.97.39:4444/wd/hub"), dc));
				}
